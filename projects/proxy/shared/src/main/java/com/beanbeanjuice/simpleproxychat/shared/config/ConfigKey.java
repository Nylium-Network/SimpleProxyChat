...
public enum ConfigKey {
    ...
    MINECRAFT_FLUXER_ENABLED(ConfigFileType.MESSAGES, "minecraft.fluxer.enabled", Boolean.class),
    MINECRAFT_FLUXER_MESSAGE(ConfigFileType.MESSAGES, "minecraft.fluxer.message", String.class),
    MINECRAFT_FLUXER_EMBED_USE(ConfigFileType.MESSAGES, "minecraft.fluxer.embed.use", Boolean.class),
    MINECRAFT_FLUXER_EMBED_TITLE(ConfigFileType.MESSAGES, "minecraft.fluxer.embed.title", String.class),
    MINECRAFT_FLUXER_EMBED_MESSAGE(ConfigFileType.MESSAGES, "minecraft.fluxer.embed.message", String.class),
    MINECRAFT_FLUXER_EMBED_COLOR(ConfigFileType.MESSAGES, "minecraft.fluxer.embed.color", Color.class),
    MINECRAFT_FLUXER_EMBED_USE_TIMESTAMP(ConfigFileType.MESSAGES, "minecraft.fluxer.embed.use-timestamp", Boolean.class),
    ...
    FLUXER_JOIN_ENABLED(ConfigFileType.MESSAGES, "fluxer.join.enabled", Boolean.class),
    ...
    FLUXER_LEAVE_USE_EMBED(ConfigFileType.MESSAGES, "fluxer.leave.use-embed", Boolean.class),
    FLUXER_SWITCH_ENABLED(ConfigFileType.MESSAGES, "fluxer.switch.enabled", Boolean.class),
    FLUXER_SWITCH_MESSAGE(ConfigFileType.MESSAGES, "fluxer.switch.message", String.class),
    FLUXER_SWITCH_USE_TIMESTAMP(ConfigFileType.MESSAGES, "fluxer.switch.use-timestamp", Boolean.class),
    FLUXER_SWITCH_USE_EMBED(ConfigFileType.MESSAGES, "fluxer.switch.use-embed", Boolean.class),
    FLUXER_CHAT_ENABLED(ConfigFileType.MESSAGES, "fluxer.chat.enabled", Boolean.class),
    FLUXER_CHAT_MINECRAFT_MESSAGE(ConfigFileType.MESSAGES, "fluxer.chat.minecraft-message", String.class),
    FLUXER_TOPIC_ONLINE(ConfigFileType.MESSAGES, "fluxer.topic.online", String.class),
    FLUXER_TOPIC_OFFLINE(ConfigFileType.MESSAGES, "fluxer.topic.offline", String.class),
    FLUXER_PROXY_STATUS_ENABLED(ConfigFileType.MESSAGES, "fluxer.proxy-status.enabled", Boolean.class),
    FLUXER_PROXY_STATUS_MODULE_ENABLED(ConfigFileType.MESSAGES, "fluxer.proxy-status.messages.enabled", String.class),
    FLUXER_PROXY_STATUS_MODULE_DISABLED(ConfigFileType.MESSAGES, "fluxer.proxy-status.messages.disabled", String.class),
    FLUXER_PROXY_STATUS_MODULE_TITLE(ConfigFileType.MESSAGES, "fluxer.proxy-status.messages.title", String.class),
    FLUXER_PROXY_STATUS_MODULE_MESSAGE(ConfigFileType.MESSAGES, "fluxer.proxy-status.messages.message", String.class),
    FLUXER_PROXY_STATUS_MODULE_ONLINE(ConfigFileType.MESSAGES, "fluxer.proxy-status.messages.online", String.class),
    FLUXER_PROXY_STATUS_MODULE_OFFLINE(ConfigFileType.MESSAGES, "fluxer.proxy-status.messages.offline", String.class),
    FLUXER_PROXY_STATUS_MODULE_USE_TIMESTAMP(ConfigFileType.MESSAGES, "fluxer.proxy-status.messages.use-timestamp", Boolean.class),
